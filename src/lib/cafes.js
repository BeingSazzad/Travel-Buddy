...
export const CAFES = [
  {
    name: "Café Norden", city: "Copenhagen", country: "Denmark", image: img("1554118811-1e0d58224f24"),
    ...
    gallery: [img("1554118811-1e0d58224f24"), img("1554118811-1e0d58224f24"), img("1453614512568-c4034dfb0fa0")],
  ...
  {
    name: "The Tiny Cup", city: "Lisbon", country: "Portugal", image: img("1453614512568-c4034dfb0fa0"),
    ...
    gallery: [img("1453614512568-c4034dfb0fa0"), img("1495474472287-4d71bcdd2085"), img("1554118811-1e0d58224f24")],
  ...
  {
    name: "Brew & Bloom", city: "Bali", country: "Indonesia", image: img("1495474472287-4d71bcdd2085"),
    ...
    gallery: [img("1495474472287-4d71bcdd2085"), img("1554118811-1e0d58224f24"), img("1453614512568-c4034dfb0fa0")],
  ...
  {
    name: "Fabrica Coffee Roasters", city: "Lisbon", country: "Portugal", image: img("1554118811-1e0d58224f24"),
    ...
    gallery: [img("1554118811-1e0d58224f24"), img("1453614512568-c4034dfb0fa0"), img("1495474472287-4d71bcdd2085")],
  ...
  {
    name: "Democratic Coffee", city: "Copenhagen", country: "Denmark", image: img("1453614512568-c4034dfb0fa0"),
    ...
    gallery: [img("1453614512568-c4034dfb0fa0"), img("1554118811-1e0d58224f24"), img("1495474472287-4d71bcdd2085")],
  ...
  {
    name: "Seniman Coffee", city: "Bali", country: "Indonesia", image: img("1495474472287-4d71bcdd2085"),
  ...
  {
    name: "Café de Flore", city: "Paris", country: "France", image: img("1554118811-1e0d58224f24"),
  ...
  {
    name: "Boot Café", city: "Paris", country: "France", image: img("1453614512568-c4034dfb0fa0"),
  ...
  {
    name: "Hello, Kristof", city: "Copenhagen", country: "Denmark", image: img("1495474472287-4d71bcdd2085"),
  ...
  {
    name: "Seaview Roastery", city: "Cape Town", country: "South Africa", image: img("1554118811-1e0d58224f24"),
    ...
    gallery: [img("1554118811-1e0d58224f24"), img("1495474472287-4d71bcdd2085"), img("1453614512568-c4034dfb0fa0")],
