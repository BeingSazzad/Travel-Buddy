  ...
  return (
    <div className="w-full flex flex-col items-center bg-background pt-14 pb-8">
      <div className="flex flex-col items-center">
        <Moon className="w-5 h-5 text-[#A1846B] mb-1" strokeWidth={1.5} />
        <h1 className="font-display font-semibold text-4xl tracking-[0.08em] text-[#A1846B]">
          SELUNA
        </h1>
      </div>
      ...
      <div className="flex items-center gap-3 mt-2 w-56">
        ...
        <Moon className="w-3 h-3 text-[#A1846B]" strokeWidth={1.5} />
        <span className="h-px flex-1 bg-[#A1846B]/30" />
      </div>
