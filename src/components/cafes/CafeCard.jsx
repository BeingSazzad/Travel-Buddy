...
export default function CafeCard({ cafe }) {
  ...
  return (
    <div onClick={() => navigate(`/cafes/${encodeURIComponent(cafe.name)}`)} className="rounded-2xl overflow-hidden border border-border shadow-soft bg-card cursor-pointer card-press">
