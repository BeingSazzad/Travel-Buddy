    ...
    <div className="w-full max-w-sm mx-auto">
      ...
      >
        <div className="relative h-64 shrink-0">
          ...
          <motion.div
            ...
            className="absolute top-4 left-4 border-4 border-[#B0897A] text-[#B0897A] font-display text-xl font-bold rounded-xl px-3 py-1 -rotate-12"
          >
            SKIP
          </motion.div>
          <motion.div
            style={{ opacity: likeOpacity }}
            className="absolute top-4 right-4 border-4 border-[#A1846B] text-[#A1846B] font-display text-xl font-bold rounded-xl px-3 py-1 rotate-12"
          >
            CONNECT
          </motion.div>
      ...
      <div className="flex items-center justify-center gap-5 mt-6">
        ...
        <button
          ...
          aria-label="Connect"
          className="w-14 h-14 rounded-full bg-[#A1846B] text-white shadow-soft flex items-center justify-center hover:scale-105 transition active:scale-95"
        >
