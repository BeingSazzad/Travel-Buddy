...
const Dialog = (props) => <DialogPrimitive.Root modal={false} {...props} />
...
const DialogOverlay = React.forwardRef(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      "fixed inset-0 z-50 bg-black/80 left-1/2 -translate-x-1/2 w-full max-w-app data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=open]:duration-500 data-[state=closed]:duration-500",
      className
    )}
    {...props} />
))
